...
Param(
  ...
  [string] $TemplateFile = '..\Templates\QiMataCaptainPlanetFoundationWebApiApp.json',
  [string] $TemplateParametersFile = '..\Templates\QiMataCaptainPlanetFoundationWebApiApp.param.dev.json',
